...
def plot_WIBEth_by_channel(df_dict,var,det_name,run=None,trigger=None,seq=None,yrange=None,jpeg_base=None):
    ...
    df_tmp["element_plane_label"] = df_tmp[["element","plane"]].apply(lambda x: f'{x.element}, Plane {x.plane}',axis=1)
...
def plot_WIBEth_adc_map(df_dict,tpc_det_key,element,plane,
